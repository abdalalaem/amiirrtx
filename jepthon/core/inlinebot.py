...
def main_menu():
    text = f"**- [سـورس ريبثون](https://t.me/amiirrtx)\
        \n المسـاعد\
        \n\
        \n◽ امير لـ {mention}**"
    buttons = [
...
async def inline_handler(event):  # sourcery no-metrics
    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:
        ...
        if query.startswith("jepiq"):
            buttons = [
                (
                    ...
                    Button.url(" amiirrtx UsᴇʀBoᴛ", "https://t.me/amiirrtx"),
                )
            ]
        ...
        buttons = [
            (
                Button.url("قنـاة السـورس ⚒️", "https://t.me/amiirrtx"),
                Button.url(
                    "كـروب المـساعدة 📬",
                    "https://t.me/amiirrtx",
                ),
